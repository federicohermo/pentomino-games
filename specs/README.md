...
hidratados: **136 casillas `[M]` repartidas en 35 specs**, y de todas ellas sólo **6** se
...
razonables — **136 contra 6** es lo único que no se puede volver a sostener.

**Los specs anteriores conservan sus `[M]`, los 136.** Por la Desviación 2 un spec mergeado no se
...
que sí se sigue pudiendo es **corregir la clasificación** de una tarea vieja que quedó mal marcada:
ponerle `[M]` a una que sólo se cierra a oído, cuando la única alternativa era marcarla `[x]`, o sea
afirmar que alguien escuchó cuando nadie escuchó. Eso no es un
...
que hace legibles los 136 `[M]` de los 35 specs anteriores—, pero a una tarea nueva le queda uno solo,
