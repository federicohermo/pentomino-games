...
|------|-------|--------|-------------|
| [001](https://github.com/federicohermo/pentomino-games/issues/63) | 2026-08-02 | Descartado | Asignar cada nota a una celda de la pieza, en orden angular alrededor del centroide. **Absorbido por el [007](./007-nota-por-celda-y-lenguaje-visual/spec.md)**, que conserva su mapeo (D1 y D3) y revisa su desempate (D2) con una medición |
...
| [004](https://github.com/federicohermo/pentomino-games/issues/66) | 2026-08-02 | Superado | La columna de la celda de agarre determina en qué momento del compás arranca la pieza: el tablero pasa a ser un secuenciador. **Superado por el [009](./009-el-tablero-como-recorrido/spec.md)** |
